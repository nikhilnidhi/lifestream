...
body:SingleChildScrollView(
  ...
  height: 896,
  color: Colors.white,
  padding: const EdgeInsets.only(top: 127, bottom: 272, ),
  child: Column(
          ...
          children:[Positioned.fill(
            child: Align(
              ...
              child: Container(
                ...
                padding: const EdgeInsets.only(left: 246, right: 50, top: 7, bottom: 35, ),
                child: Stack(
                  children: [
                    Positioned.fill(
                      child: Row(
                        ...
                        children:[
                          Container(
                            ...
                            child: FlutterLogo(size: 87.73168182373047),
                          ),
                        ],
                      ),
                    ),
                    Positioned.fill(
                      child: FlutterLogo(size: 129.7739715576172),
                    ),
                  ],
                ),
              ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                padding: const EdgeInsets.only(left: 17, right: 230, top: 2, bottom: 12, ),
                child: Stack(
                  children: [
                    Positioned.fill(
                      child: Row(
                    ...
                    Positioned.fill(
                      child: FlutterLogo(size: 125.92930603027344),
                    ),
                  ],
                ),
              ),
                ...
                child: Column(
                  ...
                  children:[
                    ...
                    Container(
                      ...
                      padding: const EdgeInsets.only(left: 14, right: 52, bottom: 59, ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
